...
### Run examples
We provide examples on how to do basic operations: loading the accelerator module extensions, performing matmuls, preloading and flushing the array's PEs, performing fault injections, etc. Those are available in the folder `pythorch/examples`.
